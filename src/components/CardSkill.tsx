...
const ChartSkill = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center px-4 py-10 text-white relative">
      {/* Efeito superior futurista */}
      <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-40 h-[20px] bg-cyan-300 rounded-b-[8px] shadow-[0_0_10px_#00fff7] clip-path-top" />
      ...
      <div className="rounded-2xl shadow-xl p-6 max-w-md w-full bg-[#051614]/40 backdrop-blur-md">
      ...
      <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-40 h-[20px] bg-cyan-300 rounded-t-[8px] shadow-[0_0_10px_#00fff7] clip-path-bottom" />
    </div>
  );
};
